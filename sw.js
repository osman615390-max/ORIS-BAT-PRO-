const CACHE='oris-v6-3-verified360';
const CORE=['./','./index.html','./style.css?v=6.3','./script.js?v=6.3','./logo-oris-bat-pro.svg','./favicon.svg','./hero-1.webp','./hero-2.webp','./fleet-real.webp','./studio-360.html','./viewer3d.js?v=6.3','./passeport-projet.html','./devis.html','./contact.html'];
