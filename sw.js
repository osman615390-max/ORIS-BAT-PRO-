const CACHE='oris-v6-1-stable-360';
const CORE=['./','./index.html','./style.css?v=6.1','./script.js?v=6.1','./logo-oris-bat-pro.svg','./favicon.svg','./hero-1.webp','./hero-2.webp','./fleet-real.webp','./studio-360.html','./viewer3d.js?v=6.1','./passeport-projet.html','./devis.html','./contact.html'];
